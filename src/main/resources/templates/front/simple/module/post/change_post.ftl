...
<section id="changePost" class="mb-5">
    <div class="d-flex px-1 flex-md-row flex-column">
        <#if prePost??>
            <a id="prePost" class="mr-auto font-weight-bold" href="/archives/${prePost.postUrl!}">
        ...
        <#if nextPost??>
            <a id="nextPost" class="font-weight-bold mt-md-0 mt-3" href="/archives/${nextPost.postUrl!}">
                <span class="icon mr-2 d-md-none d-inline">
                    下一篇：
                </span>
                ${nextPost.postTitle!}
