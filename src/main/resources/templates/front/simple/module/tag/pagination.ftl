<#--标签界面分页ok-->
<#macro pagination posts rainbow tagName>
                ...
                <ul class="pagination">
                    ...
                    <li class="page-item <#if posts.number lte 0>disabled</#if>">
                        <#if posts.number lte 0>
                            <a class="page-link" href="${context!}/tags/${tagName}/page/1" tabindex="-1"
                               aria-disabled="true">&laquo;</a>
                        <#else>
                            <a class="page-link"
                               href="${context!}/tags/${tagName}/page/${posts.number}"
                               aria-label="上一页">
                    ...
                    <#list rainbow as r>
                        ...
                        <#else>
                            <li class="page-item">
                                <a href="${context!}/tags/${tagName}/page/${r}"
                                   class="page-link">${r}
                                </a>
                            </li>
                        </#if>
                    ...
                    <li class="page-item <#if posts.getTotalPages() lte posts.number + 1>disabled</#if>">
                        ...
                        <#else>
                            <a class="page-link"
                               href="${context!}/tags/${tagName}/page/${posts.number + 2}"
                               aria-label="下一页">
